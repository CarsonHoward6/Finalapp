...
import { Trophy, Users, Radio, BarChart3, Shield, Gamepad2 } from "lucide-react";

const features = [
    {
        icon: Trophy,
        title: "Tournaments",
        description: "Create and manage competitive tournaments with advanced bracket systems"
    },
    {
        icon: Users,
        title: "Teams & Rosters",
    ...
    },
    {
        ...
        description: "Stream your matches and watch others compete in real-time"
    },
    {
        icon: BarChart3,
        title: "Analytics",
        description: "Track your performance with detailed stats and insights"
    },
    {
        icon: Shield,
        title: "Roles & Permissions",
        description: "Organize with admins, coaches, and players per tournament"
    },
    {
        icon: Gamepad2,
        title: "Multi-Game Support",
        description: "Support for all major esports titles and custom games"
    }
];
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                        ProGrid is the all-in-one platform for competitive gaming. Organize tournaments,
                        build teams, track stats, and connect with the community.
                    </p>
                </motion.div>
